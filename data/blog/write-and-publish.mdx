...
draft: false
summary: "I'm starting a weekly writing and publishing habit for fast feedback loops"
---
...
Currently I am stil on the edge about writng here versus directly just writing on [X.com](https://x.com). But the platform risk and not owning the data are strong reasons for me to write here. For now, i am sticking to this blog to own my work, but will share it on X for feedback.
