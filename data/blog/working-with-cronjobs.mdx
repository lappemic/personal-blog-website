...
Cronjobs are a way to schedule any jobs on your machine/server: run a script, remove files, copy data, make backups. It is a very convenient way to actually automate regular and tedious work. As explained in [Setting up new linux server](https://www.michaelscheiwiller.com/blog/setting-up-new-server) my motivation to do so, was the jobscraper of [NextGenEnergyJobs.com](https://www.nextgenenergyjobs.com).
